<div class="row mt-3">
    ...
    <div class="col-12" v-if="!h.d.addresses.length">
        <x-errors :msg="__('cart.emptyAddressList')" cls="px-4 py-2"
    ...
    <div class="col-12" v-if="h.d.emptyAddressList">
        <x-errors :msg="__('cart.emptyAddressList')" cls="px-4 py-2"
            type="warning" icon="exclamation"></x-errors>
    </div>
    @endguest
            ...
            <div class="card-body">
                <div class="row">
                    <div class="address-item pointer transition col-11 col-sm-5 border py-2 m-1"
                        v-for="adr in h.d.addresses"
                        :key="adr.id * Math.random()"
                    ...
                    <div class="col-11 col-sm-5 border py-2 m-1"
                        v-for="adrlod in h.d.addressesLoader"
                        :key="adrlod * Math.random()">
                        <content-loader width="120" height="60"
                            primary-color="#cbcbcd" secondary-color="#02103b">
                            <rect x="0" y="8" rx="0" ry="0" width="100"
                                height="12"></rect>
                            <rect x="0" y="26" rx="0" ry="0" width="75"
                                height="6"></rect>
                            <rect x="-1" y="36" rx="0" ry="0" width="75"
                                height="6"></rect>
                            <rect x="-1" y="49" rx="0" ry="0" width="90"
                                height="8"></rect>
                        </content-loader>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-6 mb-2 mb-sm-0">
                        <button type="button" class="btn btn-success mb-2"
                            v-on:click="h.d.showAddressForm()">
