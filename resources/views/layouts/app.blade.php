...
<body>
  ...
  <div
    style="position: fixed; top: 0;left: 0; z-index:9999; width: 100%; height: 100%; background-color: #343a40"
    id="splashScreen">
...
@stack('scripts')
<script>
  window['xjs'] = window['xjs'] || {};xjs['xlang'] = [
