...
<nav id='index-nav' class="navbar sticky-top navbar-expand navbar-dark bg-primary shadow-sm transition"
    :class="{'bg-transparent': (h.d.carouselHeight && h.d.scrollTop < (h.d.carouselHeight -20))}">
