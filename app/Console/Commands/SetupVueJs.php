    ...
    public function handle(Filesystem $fs)
    {
        ...
        if ($this->option('g')) {
            ...
            if ($this->option('i')) {
                ...
                $fs->put($kebpage .'.vue', $this->getComponentTxt($pageName));

                $this->info($kebpage .'.vue component was created succeffully');
                ...
                // add mixin to pagename
                if (!Str::contains('Mixin', $pageName)) {
                    $pageName .= 'Mixin';
                    $kebpage .= '-mixin';
                }

                $fs->put($kebpage .'.ts', $this->getMixinTxt($pageName));

                $this->info($kebpage .'.ts mixin was created succeffully');
